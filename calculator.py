...
tk_calc = Tk()
tk_calc.configure(bg="#98FF98", bd=10)
...
text_display = Entry(tk_calc, font=('sans-serif', 20, 'bold'), textvariable=text_input,
                     bd=5, insertwidth = 5, bg='white', justify='right').grid(row=0, column=0, columnspan=6, padx = 10, pady = 15)


button_params = {'bd':5, 'fg':'white', 'bg':'black', 'font':('sans-serif', 20, 'bold')}
